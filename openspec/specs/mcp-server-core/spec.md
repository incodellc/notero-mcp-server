...
## Purpose
Define the core transport, capability advertisement, health check, and request logging behaviour of the MCP server process. The server is a standalone Fastify service deployed at `mcp.notero.ai` using the MCP Streamable HTTP transport.
