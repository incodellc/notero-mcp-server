...
## Purpose
Define the four MCP resource providers exposed by the server: meeting metadata, meeting summary, meeting transcript, and user profile. Each resource is returned as UTF-8 markdown. A dedicated formatter layer decouples markdown generation from MCP protocol concerns.
